...
@interface ZhuoYinViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIViewControllerPreviewingDelegate>

@end

@implementation ZhuoYinViewController{
...
- (void)viewDidLoad {
    ...
    soundArray = Utils.getZYSoundArray;
