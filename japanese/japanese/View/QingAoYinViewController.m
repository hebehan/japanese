...
@interface QingAoYinViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIViewControllerPreviewingDelegate>

@end

@implementation QingAoYinViewController{
...
- (void)viewDidLoad {
    ...
    soundArray = Utils.getQAYSoundArray;
